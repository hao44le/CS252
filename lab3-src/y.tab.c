...
# define YYTOKENTYPE
   ...
   enum yytokentype {
     ...
     PIPE = 265,
     AMPERSAND = 266,
     APPENDREDIRECTANDERROR = 267,
     REDIRECTOUTANDERROR = 268
   };
#endif
/* Tokens.  */
#define WORD 258
...
#define APPENDREDIRECTANDERROR 267
#define REDIRECTOUTANDERROR 268
...
static const yytype_int8 yyrhs[] =
{
      ...
      21,    -1,    -1,     3,    -1,     4,    -1,     3,    -1,    23,
      24,    -1,    -1,     6,     3,    -1,     8,     3,    -1,     9,
       3,    -1,    13,     3,    -1,    12,     3,    -1,    11,    -1,
      -1
};
...
{
       0,    51,    51,    55,    56,    60,    63,    64,    68,    69,
      73,    78,    79,    82,    85,   175,   181,   182,   186,   195,
     205,   215,   225,   236,   239
};
#endif
...
static const char *const yytname[] =
{
  ...
  "NEWLINE", "LESS", "GREATGREAT", "PIPE", "AMPERSAND",
  "APPENDREDIRECTANDERROR", "REDIRECTOUTANDERROR", "$accept", "goal",
  "commands", "complex_command", "commands_with_pipe", "command_and_args",
  "argument_list", "argument", "command_word", "iomodifier_list",
  "iomodifier_opt", "background_task", YY_NULL
};
#endif
...
{
       0,     0,    15,     6,     0,     0,     3,    17,     9,    12,
       7,     1,     4,     0,    24,    10,     8,     0,     0,     0,
      23,     0,     0,    16,     0,    13,    14,    11,    18,    19,
      20,    22,    21,     5
};
...
static const yytype_int8 yytable[] =
{
      17,    11,    18,    19,    10,    20,    21,    22,    -2,     1,
       1,     2,     2,    25,    26,     3,     3,    13,     2,    28,
      29,    30,    31,    32,    16,     0,     0,    12,    33
};
...
#line 85 "shell.y"
    ...
    if ((pid = fork()) == 0) {
        ...
        //clean up user input
        char * buf = (char *)malloc(sizeof(char) * (strlen((yyvsp[(1) - (1)].string_val)) + 2));
        char * bufferHelper = buf;
        
        while (*(yyvsp[(1) - (1)].string_val)) {
            *bufferHelper++ = *(yyvsp[(1) - (1)].string_val)++;
        }
        *bufferHelper++ = '\n';
        *bufferHelper++ = '\0';
        //printf("buf is:%s\n",buf);
